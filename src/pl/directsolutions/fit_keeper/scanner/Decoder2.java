...
public final class Decoder2 {
  ...
  public DecoderResult decode(BitMatrix bits, Hashtable hints)
    ...
    BitMatrixParser2 parser = new BitMatrixParser2(bits);
    ...
    DataBlock2[] dataBlocks = DataBlock2.getDataBlocks(codewords, version, ecLevel);
    ...
    for (int j = 0; j < dataBlocks.length; j++) {
      DataBlock2 dataBlock = dataBlocks[j];
    ...
    return DecodedBitStreamParser2.decode(resultBytes, version, ecLevel, hints);
  }
